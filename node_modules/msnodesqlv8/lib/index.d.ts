...
declare module 'msnodesqlv8' {
    ...
    interface PoolOptionsEventCb {
        (options: PoolOptions): void
    }

    interface PoolOpenCb {
        (err: Error, options: PoolOptions): void
    }
    ...
    interface TableCb {
        (err: Error, table: Table): void
    }

    interface BindCb {
        (cb: BulkTableMgr): void
    }

    interface GetTableCb {
        (err: Error, table: BulkTableMgr): void
    }
    ...
    interface QueryRawCb {
        (err?: Error, raw?: RawData, more?: boolean): void
    }
    ...
    interface DescribeProcedureCb {
        (description?: ProcedureSummary): void
    }

    interface GetProcedureCb {
        (procedure?: ProcedureDefinition): void
    }

    interface GetProcCb {
        (err: Error, procedure?: ProcedureDefinition): void
    }
    ...
    */
    ...
    interface NativeReadColumnCb {
        (err: Error, results: NativeReadColumnInfo): void
    }

    interface NativeNextResultCb {
        (err: Error, results: NativeNextResultInfo): void
    }

    interface NativeUnbindCb {
        (err: Error, outputVector: any[]): void
    }

    interface NativePrepareCb {
        (err: Error, meta: Meta[]): void
    }

    interface NativeQueryCb {
        (err: Error, results: NativeNextResultInfo, more: boolean): void
    }
